    ...
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          className="fixed bottom-5 right-5 z-50 hidden items-center gap-3 rounded-full bg-[#25D366] py-3 pl-3 pr-5 text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)] lg:flex"
        >
